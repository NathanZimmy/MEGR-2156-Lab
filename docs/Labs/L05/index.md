...
## Outcome and Lessons Learned
 In the end My design did not work. I made a mistake when modeling the final product of making the hole smaller instead of offsetting it from the center so the hook would actually snap in. This made the hook too big to be able to slide into the hole at all. But Through all my mistake I learned so much about being thorough in my work and double checking everything before I print something. This lesson can play a bigger picture than simple 3D printing as well because in the future when I'm working on real project I need to make sure everything is perfect and working before the due date is up. I also got firsthand experience on what failure is like and that not everything goes to plan how you want it the first time in engineering. engineering take prototypes and trial and error and even a few failures before coming out with a full finished working product. Besides real world lessons I gained a lot more knowledge on designing things under stress or objects that will undergo stress in order to work and how we as engineers work around and take those factors into account. 
